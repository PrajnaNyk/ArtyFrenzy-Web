...
export default function LoginPage({ onSwitchToRegister, onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      login({ name: "Art Lover", email: form.email }, "demo-jwt-token-123");
      onClose && onClose();
    } catch (err) {
      ...
      <div className="auth-left">
        <div className="auth-art-stack">
          <div className="auth-art auth-art-1">
            <img src="https://images.unsplash.com/photo-1541961017774-22349e4a1262?w=400&q=80" alt="" />
          </div>
          <div className="auth-art auth-art-2">
            <img src="https://images.unsplash.com/photo-1578301978693-85fa9c0320b9?w=400&q=80" alt="" />
          </div>
      ...
      <div className="auth-right">
        <div className="auth-form-wrap">
          <div className="auth-form-header">
            ...
            <p className="auth-sub">Don't have an account?{" "}
